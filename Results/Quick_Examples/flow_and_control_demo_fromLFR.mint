...
CHANNEL channel_4 from port_4 1 to port_1 1 connectionSpacing=1000;
...
VALVE3D valve_0 on channel_1 componentSpacing=1000.0 rotation=0.0 valveRadius=1200.0 height=250.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_1 on channel_4 componentSpacing=1000.0 rotation=0.0 valveRadius=1200.0 height=250.0 gap=600.0 width=2400.0 length=2400.0;
