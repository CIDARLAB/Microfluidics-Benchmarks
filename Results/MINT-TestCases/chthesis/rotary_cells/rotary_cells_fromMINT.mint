...
CHANNEL channel_6 from mixer_3 2 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_9 from mixer_5 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from mixer_5 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from mixer_5 2 to square_cell_trap_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from mixer_5 2 to square_cell_trap_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from mixer_6 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from port_2 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from port_3 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from port_4 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from port_5 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from port_5 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from port_5 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from port_5 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
...
VALVE3D valve_0 on channel_8 componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0 ;
