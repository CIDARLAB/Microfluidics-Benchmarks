...
CHANNEL channel_2 from mixer_3 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_3 from mixer_10 2 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from mixer_14 2 to mixer_15 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from mixer_20 2 to mixer_21 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from mixer_16 2 to mixer_17 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from mixer_9 2 to mixer_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from mixer_26 2 to mixer_27 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_9 from mixer_21 2 to mixer_22 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from mixer_28 2 to mixer_14 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from mixer_15 2 to mixer_16 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from mixer_25 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from mixer_27 2 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from mixer_5 2 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from mixer_23 2 to mixer_24 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from mixer_7 2 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from mixer_11 2 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from mixer_4 2 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from mixer_18 2 to mixer_19 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from mixer_17 2 to mixer_18 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from mixer_12 2 to mixer_13 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_24 from mixer_19 2 to mixer_20 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_25 from mixer_29 2 to mixer_30 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_26 from mixer_24 2 to mixer_25 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from mixer_2 2 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_28 from mixer_8 2 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_29 from mixer_13 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_30 from mixer_30 2 to mixer_28 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_31 from port_2 1 to mixer_18 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_32 from port_2 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_33 from port_3 1 to mixer_27 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_34 from port_3 1 to mixer_30 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_35 from port_4 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_36 from port_4 1 to mixer_17 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_37 from port_5 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_38 from port_5 1 to mixer_15 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_39 from port_6 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_40 from port_6 1 to mixer_21 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_41 from port_7 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_42 from port_7 1 to mixer_19 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_43 from port_8 1 to mixer_20 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_44 from port_8 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_45 from port_9 1 to mixer_26 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_46 from port_9 1 to mixer_29 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_47 from port_10 1 to mixer_16 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_48 from port_10 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_49 from port_11 1 to mixer_14 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_50 from port_11 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_51 from port_12 1 to mixer_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_52 from port_12 1 to mixer_22 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_53 from port_13 1 to mixer_26 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_54 from port_13 1 to mixer_29 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_55 from port_14 1 to mixer_23 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_56 from port_14 1 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_57 from port_15 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_58 from port_15 1 to mixer_28 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_59 from port_16 1 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_60 from port_16 1 to mixer_24 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_61 from port_17 1 to mixer_25 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_62 from port_17 1 to mixer_13 1 connectionSpacing=1000 channelWidth=400  ;
...
VALVE3D valve_0 on channel_12 componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0 ;
