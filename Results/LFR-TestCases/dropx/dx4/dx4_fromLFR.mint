...
DROPLET SORTER droplet_sorter_3componentSpacing=1000.0 rotation=0.0 height=250.0 inletWidth=800.0 inletLength=4000.0 electrodeDistance=1000.0 electrodeWidth=700.0 electrodeLength=5000.0 outletWidth=800.0 angle=45.0 wasteWidth=1200.0 outputLength=4000.0 keepWidth=2000.0 pressureWidth=400.0 pressureSpacing=1500.0 numberofDistributors=5.0 channelDepth=1000.0 electrodeDepth=1000.0 pressureDepth=1000.0 mirrorByX=0.0 mirrorByY=0.0;
...
CHANNEL channel_6 from droplet_sorter_1 3 to droplet_sorter_2 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_7 from droplet_sorter_1 3 to droplet_sorter_3 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_8 from droplet_sorter_3 3 to port_5 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_9 from droplet_sorter_3 3 to port_6 1 connectionSpacing=1000 channelWidth=400;
...
CHANNEL channel_12 from mixer_4 2 to mixer_2 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_13 from mixer_1 2 to droplet_sorter_1 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_14 from mixer_5 2 to mixer_3 1 connectionSpacing=1000 channelWidth=400;
...
CHANNEL channel_18 from port_10 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_19 from port_10 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_20 from port_11 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400;
