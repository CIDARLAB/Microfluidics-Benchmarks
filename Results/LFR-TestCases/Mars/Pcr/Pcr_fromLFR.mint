...
CHANNEL channel_1 from droplet_capacitance_sensor_1 2 to droplet_capacitance_sensor_2 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_2 from droplet_capacitance_sensor_2 2 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_3 from port_2 1 to droplet_capacitance_sensor_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
