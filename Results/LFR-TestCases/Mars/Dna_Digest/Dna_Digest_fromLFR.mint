...
CHANNEL channel_7 from reaction_chamber_1 4 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from nozzle_droplet_generator_1 3 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_9 from nozzle_droplet_generator_2 3 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_10 from nozzle_droplet_generator_3 3 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_11 from mixer_1 2 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_12 from mixer_2 2 to reaction_chamber_1 2 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_13 from port_8 1 to nozzle_droplet_generator_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_14 from port_9 1 to nozzle_droplet_generator_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_15 from port_10 1 to nozzle_droplet_generator_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
