...
CHANNEL channel_6 from nozzle_droplet_generator_1 3 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_7 from nozzle_droplet_generator_2 3 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from mixer_1 2 to reaction_chamber_1 2 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_9 from port_6 1 to nozzle_droplet_generator_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_10 from port_7 1 to nozzle_droplet_generator_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
