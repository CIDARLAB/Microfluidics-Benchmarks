...
CHANNEL channel_4 from port_5 1 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from port_5 1 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from port_6 1 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from port_6 1 to port_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from port_6 1 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
...
VALVE3D valve_3 on channel_3 componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0 ;
...
VALVE3D valve_6 on channel_6 componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0 ;
