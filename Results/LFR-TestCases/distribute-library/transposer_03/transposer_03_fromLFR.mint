...
CHANNEL channel_6 from port_5 1 to port_4 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_7 from port_6 1 to port_2 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_8 from port_6 1 to port_4 1 connectionSpacing=1000 channelWidth=400;
...
VALVE3D valve_0 on channel_7componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
...
VALVE3D valve_2 on channel_6componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
...
VALVE3D valve_4 on channel_5componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_5 on channel_2componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_6 on channel_3componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
