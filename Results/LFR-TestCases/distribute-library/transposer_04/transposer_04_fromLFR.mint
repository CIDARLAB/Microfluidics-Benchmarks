...
CHANNEL channel_3 from port_3 1 to port_5 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_4 from port_3 1 to port_6 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_5 from port_7 1 to port_4 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_6 from port_7 1 to port_5 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_7 from port_7 1 to port_6 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_8 from port_8 1 to port_5 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_9 from port_8 1 to port_6 1 connectionSpacing=1000 channelWidth=400;
...
VALVE3D valve_0 on channel_9componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_1 on channel_8componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_2 on channel_3componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_3 on channel_4componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_4 on channel_2componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_5 on channel_5componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_6 on channel_6componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_7 on channel_7componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
VALVE3D valve_8 on channel_1componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
