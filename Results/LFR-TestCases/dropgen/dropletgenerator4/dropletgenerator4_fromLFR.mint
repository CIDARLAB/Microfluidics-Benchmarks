...
CHANNEL channel_2 from reaction_chamber_2 4 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_3 from mixer_1 2 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from mixer_4 2 to port_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from mixer_3 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from mixer_2 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from port_3 1 to reaction_chamber_1 2 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from port_4 1 to reaction_chamber_2 2 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_12 from port_6 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
