...
CHANNEL channel_4 from port_4 1 to port_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from port_4 1 to port_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from port_4 1 to port_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from port_4 1 to port_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from port_4 1 to port_9 1 connectionSpacing=1000 channelWidth=400  ;
...
VALVE3D valve_2 on channel_6 componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0 ;
...
VALVE3D valve_5 on channel_4 componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0 ;
