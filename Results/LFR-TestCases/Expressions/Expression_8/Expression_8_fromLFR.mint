...
CHANNEL channel_3 from mixer_3 2 to port_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_4 from mixer_4 2 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_5 from port_3 1 to mixer_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_6 from port_4 1 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_7 from port_4 1 to mixer_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from port_4 1 to mixer_4 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
