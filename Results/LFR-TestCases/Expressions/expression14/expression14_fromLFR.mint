...
CHANNEL channel_25 from port_25 1 to nozzle_droplet_generator_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_26 from port_26 1 to nozzle_droplet_generator_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from port_27 1 to nozzle_droplet_generator_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_28 from port_28 1 to nozzle_droplet_generator_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_29 from port_29 1 to nozzle_droplet_generator_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_30 from port_30 1 to nozzle_droplet_generator_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_31 from port_31 1 to nozzle_droplet_generator_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_32 from port_32 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
