...
CHANNEL channel_3 from droplet_capacitance_sensor_1 2 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_4 from nozzle_droplet_generator_1 3 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_5 from mixer_1 2 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_6 from port_4 1 to nozzle_droplet_generator_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_7 from port_5 1 to droplet_capacitance_sensor_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
