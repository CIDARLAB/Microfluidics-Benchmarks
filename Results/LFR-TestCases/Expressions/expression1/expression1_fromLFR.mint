...
CHANNEL channel_2 from reaction_chamber_2 4 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_3 from mixer_1 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from port_2 1 to reaction_chamber_2 2 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from port_3 1 to reaction_chamber_1 2 connectionSpacing=1000 channelWidth=400  ;
