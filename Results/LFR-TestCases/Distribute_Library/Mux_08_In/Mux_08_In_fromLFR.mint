...
CHANNEL channel_1 from port_9 1 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_2 from port_9 1 to port_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_3 from port_9 1 to port_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_4 from port_9 1 to port_4 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_5 from port_9 1 to port_5 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_6 from port_9 1 to port_6 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_7 from port_9 1 to port_7 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from port_9 1 to port_8 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
