...
CHANNEL channel_10 from mixer_8 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_13 from mixer_12 2 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from port_2 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from port_2 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from port_2 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from port_2 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from port_3 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from port_3 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from port_3 1 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from port_3 1 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
