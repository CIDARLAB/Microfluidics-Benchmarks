...
CHANNEL channel_5 from mixer_1 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from mixer_1 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from mixer_1 2 to square_cell_trap_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from mixer_1 2 to square_cell_trap_4 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_12 from port_3 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from port_4 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from port_5 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
