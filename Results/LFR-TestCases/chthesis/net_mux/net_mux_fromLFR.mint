...
CHANNEL channel_2 from ytree_1 9 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_11 from ytree_1 9 to port_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from mixer_2 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from mixer_2 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from mixer_2 2 to square_cell_trap_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from mixer_2 2 to square_cell_trap_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from mixer_2 2 to square_cell_trap_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from mixer_2 2 to square_cell_trap_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from mixer_2 2 to square_cell_trap_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from mixer_2 2 to square_cell_trap_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from mixer_1 2 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from mixer_3 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_22 from mixer_4 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_23 from port_3 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_24 from port_3 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_25 from port_3 1 to port_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_26 from port_3 1 to port_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from port_3 1 to port_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_28 from port_3 1 to port_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_29 from port_3 1 to port_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_30 from port_3 1 to port_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_31 from port_3 1 to port_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_32 from port_3 1 to port_10 1 connectionSpacing=1000 channelWidth=400  ;
