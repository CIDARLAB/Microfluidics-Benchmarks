...
CHANNEL channel_4 from port_3 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_5 from port_4 1 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_6 from port_6 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_7 from port_7 1 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400;
...
VALVE3D valve_1 on channel_7componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0;
