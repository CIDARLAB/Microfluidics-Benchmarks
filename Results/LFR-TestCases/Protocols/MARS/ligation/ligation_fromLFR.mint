...
CHANNEL channel_12 from nozzle_droplet_generator_2 3 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from nozzle_droplet_generator_3 3 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from nozzle_droplet_generator_4 3 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from nozzle_droplet_generator_5 3 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_18 from mixer_2 2 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from mixer_3 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from mixer_1 2 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from port_12 1 to nozzle_droplet_generator_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_22 from port_13 1 to nozzle_droplet_generator_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_23 from port_14 1 to nozzle_droplet_generator_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_24 from port_15 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
