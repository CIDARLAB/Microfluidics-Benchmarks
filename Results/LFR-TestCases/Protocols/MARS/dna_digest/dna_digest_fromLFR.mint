...
CHANNEL channel_8 from mixer_2 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_9 from mixer_1 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from port_5 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from port_6 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
