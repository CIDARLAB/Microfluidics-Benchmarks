...
CHANNEL channel_2 from square_cell_trap_2 2 to port_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_3 from square_cell_trap_3 2 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from square_cell_trap_4 2 to port_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from square_cell_trap_5 2 to port_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from square_cell_trap_6 2 to port_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from square_cell_trap_7 2 to port_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from square_cell_trap_8 2 to port_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_9 from square_cell_trap_9 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from square_cell_trap_9 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from square_cell_trap_9 2 to square_cell_trap_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from square_cell_trap_9 2 to square_cell_trap_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from square_cell_trap_9 2 to square_cell_trap_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from square_cell_trap_9 2 to square_cell_trap_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from square_cell_trap_9 2 to square_cell_trap_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from square_cell_trap_9 2 to square_cell_trap_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from mixer_1 2 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from mixer_2 2 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from port_9 1 to square_cell_trap_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from port_10 1 to square_cell_trap_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from port_11 1 to square_cell_trap_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_22 from port_11 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_23 from port_11 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
...
VALVE3D valve_0 on channel_18 componentSpacing=1000 valveRadius=400 height=250 rotation=0.0 gap=600.0 width=2400.0 length=2400.0 ;
