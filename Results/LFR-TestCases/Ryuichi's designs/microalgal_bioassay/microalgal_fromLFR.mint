...
CHANNEL channel_6 from mixer_1 2 to square_cell_trap_4 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_7 from mixer_2 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_8 from mixer_3 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_9 from mixer_4 2 to square_cell_trap_3 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_10 from mixer_5 2 to square_cell_trap_5 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_11 from port_2 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_12 from port_2 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_13 from port_2 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_14 from port_2 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400;
CHANNEL channel_15 from port_2 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400;
