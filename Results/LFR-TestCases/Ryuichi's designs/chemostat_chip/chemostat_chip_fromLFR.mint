...
CHANNEL channel_11 from square_cell_trap_3 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from square_cell_trap_4 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from square_cell_trap_5 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from square_cell_trap_1 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from square_cell_trap_1 2 to square_cell_trap_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from square_cell_trap_1 2 to square_cell_trap_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from square_cell_trap_1 2 to square_cell_trap_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from square_cell_trap_1 2 to square_cell_trap_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from square_cell_trap_1 2 to square_cell_trap_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from square_cell_trap_1 2 to square_cell_trap_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from square_cell_trap_1 2 to square_cell_trap_9 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_26 from port_2 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from port_3 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_28 from port_4 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_29 from port_5 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_30 from port_6 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_31 from port_7 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_32 from port_8 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_33 from port_9 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_34 from port_10 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
