...
CHANNEL channel_3 from port_2 1 to port_4 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_4 from port_2 1 to port_5 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_5 from port_2 1 to port_6 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_6 from port_2 1 to port_7 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_7 from port_2 1 to port_8 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_8 from port_2 1 to port_9 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
...
VALVE3D valve_6 on channel_8 componentSpacing=1000 valveRadius=1200 gap=600 width=2400 length=2400 height=250 rotation=0.0 ;
