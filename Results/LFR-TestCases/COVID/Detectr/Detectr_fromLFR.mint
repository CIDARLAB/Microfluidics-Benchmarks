...
CHANNEL channel_1 from droplet_capacitance_sensor_1 2 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_2 from droplet_capacitance_sensor_2 2 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_3 from mixer_2 2 to droplet_capacitance_sensor_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_4 from mixer_3 2 to mixer_4 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_5 from mixer_7 2 to mixer_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_6 from mixer_6 2 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_7 from mixer_8 2 to mixer_7 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from mixer_1 2 to droplet_capacitance_sensor_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_9 from mixer_5 2 to mixer_6 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_10 from mixer_4 2 to mixer_5 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_11 from port_2 1 to mixer_7 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_12 from port_3 1 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_13 from port_4 1 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_14 from port_5 1 to mixer_6 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_15 from port_6 1 to mixer_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_16 from port_7 1 to mixer_5 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_17 from port_8 1 to mixer_8 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_18 from port_9 1 to mixer_4 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_19 from port_10 1 to mixer_8 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
