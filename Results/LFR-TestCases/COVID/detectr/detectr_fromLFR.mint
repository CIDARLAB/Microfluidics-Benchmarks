...
CHANNEL channel_1 from droplet_capacitance_sensor_2 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_2 from droplet_capacitance_sensor_3 2 to droplet_capacitance_sensor_2 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_5 from mixer_7 2 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_8 from mixer_8 2 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_9 from mixer_4 2 to droplet_capacitance_sensor_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from port_2 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from port_3 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from port_5 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from port_6 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from port_7 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from port_8 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from port_9 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from port_10 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
