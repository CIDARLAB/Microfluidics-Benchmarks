...
CHANNEL channel_2 from ytree_1 9 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_11 from mixer_6 2 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_14 from mixer_2 2 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from mixer_7 2 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from mixer_9 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_19 from mixer_3 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from port_10 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from port_11 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_22 from port_12 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_23 from port_13 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_24 from port_14 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_25 from port_15 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_26 from port_16 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from port_17 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_28 from port_18 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_29 from port_2 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_30 from port_2 1 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_31 from port_2 1 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_32 from port_2 1 to port_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_33 from port_2 1 to port_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_34 from port_2 1 to port_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_35 from port_2 1 to port_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_36 from port_2 1 to port_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_37 from port_2 1 to port_9 1 connectionSpacing=1000 channelWidth=400  ;
