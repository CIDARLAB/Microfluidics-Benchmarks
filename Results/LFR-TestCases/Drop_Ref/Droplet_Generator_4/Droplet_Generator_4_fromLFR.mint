...
CHANNEL channel_6 from nozzle_droplet_generator_2 3 to mixer_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_7 from mixer_2 2 to port_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from mixer_3 2 to mixer_4 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_9 from mixer_1 2 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_10 from mixer_4 2 to port_6 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_11 from port_7 1 to nozzle_droplet_generator_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_12 from port_8 1 to mixer_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_13 from port_8 1 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_14 from port_9 1 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_15 from port_9 1 to mixer_4 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_16 from port_10 1 to nozzle_droplet_generator_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
