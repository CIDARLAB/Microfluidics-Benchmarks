...
CHANNEL channel_5 from nozzle_droplet_generator_1 3 to square_cell_trap_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_6 from nozzle_droplet_generator_2 3 to square_cell_trap_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_7 from square_cell_trap_1 2 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from square_cell_trap_2 2 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_9 from mixer_1 2 to port_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
