...
// FLOW ports: 6 (LFR module IO declared 4)
...
//   - FLOW port count differs from LFR IO (declared 4 → physical FLOW ports 6; metering / NOZZLE DROPLET GENERATOR auxiliaries, DROPLET SORTER waste/discard ports)
...
CHANNEL channel_7 from mixer_2 2 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_8 from port_5 1 to nozzle_droplet_generator_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_9 from port_6 1 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
