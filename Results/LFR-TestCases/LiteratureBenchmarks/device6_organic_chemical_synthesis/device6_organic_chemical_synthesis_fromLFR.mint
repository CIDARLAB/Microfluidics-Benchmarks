...
CHANNEL channel_3 from mixer_8 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from mixer_3 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_9 from mixer_14 2 to mixer_15 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from mixer_11 2 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from mixer_16 2 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from mixer_10 2 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from mixer_13 2 to mixer_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from mixer_7 2 to square_cell_trap_2 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_17 from mixer_15 2 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from mixer_5 2 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from port_2 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from port_3 1 to mixer_14 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from port_4 1 to mixer_16 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_22 from port_5 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_23 from port_6 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_24 from port_7 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_25 from port_8 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_26 from port_9 1 to mixer_15 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from port_10 1 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_28 from port_11 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_31 from port_14 1 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_32 from port_15 1 to mixer_14 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_33 from port_16 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_34 from port_17 1 to mixer_13 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_35 from port_18 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
