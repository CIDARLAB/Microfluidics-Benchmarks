...
CHANNEL channel_3 from port_4 1 to droplet_capacitance_sensor_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from port_9 1 to reaction_chamber_3 2 connectionSpacing=1000 channelWidth=400  ;
