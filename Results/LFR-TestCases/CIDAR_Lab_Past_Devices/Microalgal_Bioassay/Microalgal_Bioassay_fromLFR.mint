...
CHANNEL channel_3 from square_cell_trap_1 2 to square_cell_trap_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_4 from square_cell_trap_1 2 to square_cell_trap_3 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_5 from square_cell_trap_1 2 to square_cell_trap_4 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_6 from square_cell_trap_1 2 to square_cell_trap_5 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_7 from square_cell_trap_1 2 to square_cell_trap_6 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_8 from square_cell_trap_3 2 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_9 from square_cell_trap_4 2 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_10 from square_cell_trap_5 2 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_11 from square_cell_trap_6 2 to port_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_12 from mixer_2 2 to mixer_1 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_13 from port_2 1 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
CHANNEL channel_14 from port_3 1 to mixer_2 1 crossSection=1 connectionSpacing=1000 channelWidth=800  ;
