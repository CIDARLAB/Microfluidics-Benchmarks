...
CHANNEL channel_5 from mixer_11 2 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from mixer_3 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from mixer_12 2 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from mixer_6 2 to port_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_9 from mixer_9 2 to mixer_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from mixer_10 2 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from mixer_4 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from mixer_8 2 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from port_4 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from port_4 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from port_4 1 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from port_5 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from port_5 1 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from port_5 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from port_6 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from port_6 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from port_6 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_22 from port_7 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_23 from port_7 1 to mixer_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_24 from port_7 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_25 from port_8 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_26 from port_8 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from port_8 1 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
