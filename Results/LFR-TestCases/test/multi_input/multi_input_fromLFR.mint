...
CHANNEL channel_2 from mixer_1 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_3 from mixer_2 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from port_2 1 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from port_3 1 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from port_5 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from port_6 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
