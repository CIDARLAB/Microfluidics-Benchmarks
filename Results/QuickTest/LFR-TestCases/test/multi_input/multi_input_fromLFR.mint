...
CHANNEL channel_4 from port_2 1 to mixer_1 1 connectionSpacing=1000;
...
CHANNEL channel_9 from port_7 1 to square_cell_trap_1 1 connectionSpacing=1000;
...
VALVE3D valve_0 on channel_9 controlPort=Cport_0 componentSpacing=9000;
