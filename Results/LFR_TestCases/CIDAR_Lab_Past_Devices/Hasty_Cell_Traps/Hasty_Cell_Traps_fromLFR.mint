...
CHANNEL channel_5 from port_2 1 to square_cell_trap_1 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_6 from port_2 1 to square_cell_trap_2 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_7 from port_2 1 to square_cell_trap_3 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
CHANNEL channel_8 from port_2 1 to square_cell_trap_4 1 crossSection=1 connectionSpacing=1000 channelWidth=600  ;
