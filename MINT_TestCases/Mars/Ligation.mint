...
//   - FLOW port count differs from LFR IO (declared 6 → physical FLOW ports 16; metering / NOZZLE DROPLET GENERATOR auxiliaries)
...
CHANNEL channel_11 from reaction_chamber_1 4 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_14 from nozzle_droplet_generator_3 3 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from nozzle_droplet_generator_4 3 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_18 from mixer_3 2 to reaction_chamber_1 2 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_21 from port_12 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_24 from port_15 1 to nozzle_droplet_generator_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_25 from port_16 1 to nozzle_droplet_generator_2 1 connectionSpacing=1000 channelWidth=400  ;
