...
CHANNEL channel_2 from mixer_3 2 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_3 from mixer_2 2 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_4 from mixer_4 2 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from mixer_5 2 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from mixer_6 2 to port_2 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_11 from port_5 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from port_5 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from port_6 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
