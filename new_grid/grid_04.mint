...
CHANNEL channel_horizontal_1_2 from ct_1_2 2 to ct_1_3 4 channelWidth=100  ;
CHANNEL channel_horizontal_1_3 from ct_1_3 2 to ct_1_4 4 channelWidth=100  ;
CHANNEL channel_horizontal_2_1 from ct_2_1 2 to ct_2_2 4 channelWidth=100  ;
CHANNEL channel_horizontal_2_2 from ct_2_2 2 to ct_2_3 4 channelWidth=100  ;
CHANNEL channel_horizontal_2_3 from ct_2_3 2 to ct_2_4 4 channelWidth=100  ;
CHANNEL channel_horizontal_3_1 from ct_3_1 2 to ct_3_2 4 channelWidth=100  ;
CHANNEL channel_horizontal_3_2 from ct_3_2 2 to ct_3_3 4 channelWidth=100  ;
CHANNEL channel_horizontal_3_3 from ct_3_3 2 to ct_3_4 4 channelWidth=100  ;
CHANNEL channel_horizontal_4_1 from ct_4_1 2 to ct_4_2 4 channelWidth=100  ;
CHANNEL channel_horizontal_4_2 from ct_4_2 2 to ct_4_3 4 channelWidth=100  ;
CHANNEL channel_horizontal_4_3 from ct_4_3 2 to ct_4_4 4 channelWidth=100  ;
...
CHANNEL channel_vertical_1_3 from ct_1_3 3 to ct_2_3 1 channelWidth=100  ;
CHANNEL channel_vertical_1_4 from ct_1_4 3 to ct_2_4 1 channelWidth=100  ;
CHANNEL channel_vertical_2_1 from ct_2_1 3 to ct_3_1 1 channelWidth=100  ;
CHANNEL channel_vertical_2_2 from ct_2_2 3 to ct_3_2 1 channelWidth=100  ;
CHANNEL channel_vertical_2_3 from ct_2_3 3 to ct_3_3 1 channelWidth=100  ;
CHANNEL channel_vertical_2_4 from ct_2_4 3 to ct_3_4 1 channelWidth=100  ;
CHANNEL channel_vertical_3_1 from ct_3_1 3 to ct_4_1 1 channelWidth=100  ;
CHANNEL channel_vertical_3_2 from ct_3_2 3 to ct_4_2 1 channelWidth=100  ;
CHANNEL channel_vertical_3_3 from ct_3_3 3 to ct_4_3 1 channelWidth=100  ;
CHANNEL channel_vertical_3_4 from ct_3_4 3 to ct_4_4 1 channelWidth=100  ;
...
CHANNEL channel_in_3 from input_tree 4 to ct_1_3 1 channelWidth=100  ;
CHANNEL channel_in_4 from input_tree 5 to ct_1_4 1 channelWidth=100  ;
CHANNEL channel_out_1 from ct_4_1 3 to output_tree 2 channelWidth=100  ;
CHANNEL channel_out_2 from ct_4_2 3 to output_tree 3 channelWidth=100  ;
CHANNEL channel_out_3 from ct_4_3 3 to output_tree 4 channelWidth=100  ;
CHANNEL channel_out_4 from ct_4_4 3 to output_tree 5 channelWidth=100  ;
