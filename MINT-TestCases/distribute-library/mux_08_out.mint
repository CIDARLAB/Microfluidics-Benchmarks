# Mirrored from LFR-TestCases/distribute-library/mux_08_out.lfr
...
CHANNEL channel_1 from port_5 1 to port_1 1 connectionSpacing=1000;
CHANNEL channel_2 from port_5 1 to port_2 1 connectionSpacing=1000;
CHANNEL channel_3 from port_5 1 to port_3 1 connectionSpacing=1000;
CHANNEL channel_4 from port_5 1 to port_4 1 connectionSpacing=1000;
CHANNEL channel_5 from port_5 1 to port_6 1 connectionSpacing=1000;
CHANNEL channel_6 from port_5 1 to port_7 1 connectionSpacing=1000;
CHANNEL channel_7 from port_5 1 to port_8 1 connectionSpacing=1000;
CHANNEL channel_8 from port_5 1 to port_9 1 connectionSpacing=1000;
...
VALVE3D valve_2 on channel_2 controlPort=Cport_2 componentSpacing=9000;
VALVE3D valve_3 on channel_1 controlPort=Cport_3 componentSpacing=9000;
VALVE3D valve_4 on channel_8 controlPort=Cport_4 componentSpacing=9000;
VALVE3D valve_5 on channel_5 controlPort=Cport_5 componentSpacing=9000;
VALVE3D valve_6 on channel_4 controlPort=Cport_6 componentSpacing=9000;
VALVE3D valve_7 on channel_7 controlPort=Cport_7 componentSpacing=9000;
