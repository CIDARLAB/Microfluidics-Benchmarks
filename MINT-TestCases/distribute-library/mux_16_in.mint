...
VALVE3D valve_3 on channel_15 controlPort=Cport_3 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_4 on channel_4 controlPort=Cport_4 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_5 on channel_5 controlPort=Cport_5 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_6 on channel_8 controlPort=Cport_6 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_7 on channel_11 controlPort=Cport_7 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_8 on channel_10 controlPort=Cport_8 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_9 on channel_12 controlPort=Cport_9 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_10 on channel_14 controlPort=Cport_10 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_11 on channel_9 controlPort=Cport_11 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_12 on channel_13 controlPort=Cport_12 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_13 on channel_7 controlPort=Cport_13 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_14 on channel_6 controlPort=Cport_14 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_15 on channel_16 controlPort=Cport_15 componentSpacing=1000 valveRadius=400 height=250 ;
