...
CHANNEL channel_4 from port_6 1 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_5 from port_6 1 to port_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from port_6 1 to port_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from port_7 1 to port_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from port_7 1 to port_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_9 from port_8 1 to port_2 1 connectionSpacing=1000 channelWidth=400  ;
...
VALVE3D valve_0 on channel_8 controlPort=Cport_0 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_1 on channel_7 controlPort=Cport_1 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_2 on channel_4 controlPort=Cport_2 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_3 on channel_6 controlPort=Cport_3 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_4 on channel_5 controlPort=Cport_4 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_5 on channel_2 controlPort=Cport_5 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_6 on channel_1 controlPort=Cport_6 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_7 on channel_3 controlPort=Cport_7 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_8 on channel_9 controlPort=Cport_8 componentSpacing=1000 valveRadius=400 height=250 ;
