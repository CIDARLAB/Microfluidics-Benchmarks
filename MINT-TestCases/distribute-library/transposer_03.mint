...
CHANNEL channel_5 from port_5 1 to port_4 1 connectionSpacing=1000 channelWidth=400  ;
...
VALVE3D valve_0 on channel_5 controlPort=Cport_0 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_1 on channel_4 controlPort=Cport_1 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_2 on channel_6 controlPort=Cport_2 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_3 on channel_8 controlPort=Cport_3 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_4 on channel_7 controlPort=Cport_4 componentSpacing=1000 valveRadius=400 height=250 ;
