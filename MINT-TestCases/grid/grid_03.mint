...
LAYER flow
H TREE m1 1 to 3spacing=1200 flowChannelWidth=100;
H TREE m2 3 to 1spacing=1200 flowChannelWidth=100;
PORT p1, p2portRadius=100;
SQUARE CELL TRAP ct1, ct2, ct3, ct4, ct5, ct6, ct7, ct8, ct9chamberWidth=100 chamberLength=100 channelWidth=100 ;
...
LAYER control
V BANK cpb1 of 3  PORTportRadius=100  spacing=1500 ;
V BANK cpb2 of 2  PORTportRadius=100  spacing=1500 ;

VALVE v1 on c5 width=100 length=300;
VALVE v2 on c6 width=100 length=300;

NET n1 from cpb1_1 to v1, v2channelWidth=50;

VALVE v3 on c7 width=300 length=100;
VALVE v4 on c8 width=300 length=100;
VALVE v5 on c9 width=300 length=100;

CHANNEL cc1 from v3 to v4channelWidth=50;
CHANNEL cc2 from v4 to v5channelWidth=50;
CHANNEL cc3 from v5 to cpb2_1channelWidth=50;

VALVE v6 on c10 width=100 length=300;
VALVE v7 on c11 width=100 length=300;

NET n2 from cpb1_2 to v6, v7channelWidth=50;
...
CHANNEL cc5 from v9 to v10channelWidth=50;
CHANNEL cc6 from v10 to cpb2_2channelWidth=50;

VALVE v11 on c15 width=100 length=300;
VALVE v12 on c16 width=100 length=300;

NET n3 from cpb1_3 to v11, v12channelWidth=50;
