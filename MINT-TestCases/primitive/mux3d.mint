...
CHANNEL cc1 from cp1 to m 6channelWidth=400;
CHANNEL cc2 from cp2 to m 7channelWidth=400;
CHANNEL cc3 from cp3 to m 8channelWidth=400;
CHANNEL cc4 from cp4 to m 9channelWidth=400;
