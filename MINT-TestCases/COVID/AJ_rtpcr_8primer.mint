...
CHANNEL channel_12 from port_11 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from port_12 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from port_13 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from port_14 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from port_15 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_17 from port_16 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_18 from port_17 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_19 from port_18 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from port_19 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from port_20 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
...
PORT Cport_32 componentSpacing=9000 ;
PORT Cport_33 componentSpacing=9000 ;
PORT Cport_34 componentSpacing=9000 ;
PORT Cport_35 componentSpacing=9000 ;
PORT Cport_36 componentSpacing=9000 ;
PORT Cport_37 componentSpacing=9000 ;
PORT Cport_38 componentSpacing=9000 ;
PORT Cport_39 componentSpacing=9000 ;

VALVE3D valve_32 on channel_9 controlPort=Cport_32 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_33 on channel_8 controlPort=Cport_33 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_34 on channel_10 controlPort=Cport_34 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_35 on channel_5 controlPort=Cport_35 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_36 on channel_11 controlPort=Cport_36 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_37 on channel_7 controlPort=Cport_37 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_38 on channel_4 controlPort=Cport_38 componentSpacing=1000 valveRadius=400 height=250 ;
VALVE3D valve_39 on channel_6 controlPort=Cport_39 componentSpacing=1000 valveRadius=400 height=250 ;
