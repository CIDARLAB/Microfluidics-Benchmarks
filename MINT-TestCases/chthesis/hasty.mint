...
NODE n1, n2;
V TREE t1 1 to 8spacing=500 flowChannelWidth=100 stageLength=500;
V TREE t2 1 to 8spacing=500 flowChannelWidth=100 stageLength=500;
...
CHANNEL c3 from p3 to n1channelWidth=100;
CHANNEL c4 from n1 to t1 1channelWidth=100;
...
CHANNEL c22 from n2 to p4channelWidth=100;
CHANNEL c23 from n2 to p5channelWidth=100;
