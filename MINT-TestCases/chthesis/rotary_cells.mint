...
V MUX m1 1 to 4spacing=500 width=400 length=100 stageLength=1000 flowChannelWidth=100 controlChannelWidth=50;
V MUX m2 1 to 4spacing=500 width=400 length=100 stageLength=1000 flowChannelWidth=100 controlChannelWidth=50;
V BANK pb1 of 4  PORTportRadius=100  spacing=1200 ;
H ROTARY MIXER rpradius=1000 flowChannelWidth=100 controlChannelWidth=50 valveWidth=200 valveLength=200 valveSpacing=400 height=30;
V BANK b1 of 4 LONG CELL TRAPnumberOfChambers=100 chamberWidth=100 chamberLength=100 chamberSpacing=30 feedingChannelWidth=100;
V TREE t1 1 to 4spacing=500 flowChannelWidth=100 stageLength=500;
...
CHANNEL c11 from b1_1 to t1 5channelWidth=100;
CHANNEL c12 from b1_2 to t1 4channelWidth=100;
CHANNEL c13 from b1_3 to t1 3channelWidth=100;
CHANNEL c14 from b1_4 to t1 2channelWidth=100;
...
H BANK cb1 of 2  PORTportRadius=100  spacing=1200 ;
H BANK cb2 of 2  PORTportRadius=100  spacing=1200 ;
H BANK cb3 of 3  PORTportRadius=100  spacing=1200 ;
H BANK cb4 of 2  PORTportRadius=100  spacing=1200 ;
H BANK cb5 of 2  PORTportRadius=100  spacing=1200 ;
H BANK cb6 of 2  PORTportRadius=100  spacing=1200 ;
