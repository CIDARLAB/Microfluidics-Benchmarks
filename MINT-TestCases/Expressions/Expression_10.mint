...
//   - FLOW port count differs from LFR IO (declared 3 → physical FLOW ports 5; metering / NOZZLE DROPLET GENERATOR auxiliaries)
...
CHANNEL channel_3 from droplet_capacitance_sensor_1 2 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_6 from port_4 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from port_5 1 to droplet_capacitance_sensor_1 1 connectionSpacing=1000 channelWidth=400  ;
