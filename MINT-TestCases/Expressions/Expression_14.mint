...
CHANNEL channel_3 from ytree_1 9 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_10 from ytree_1 9 to port_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from ytree_1 9 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from ytree_1 9 to port_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_13 from nozzle_droplet_generator_1 3 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_14 from square_cell_trap_1 2 to ytree_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_15 from square_cell_trap_1 2 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_16 from mixer_14 2 to mixer_15 1 connectionSpacing=1000 channelWidth=400  ;
...
CHANNEL channel_19 from mixer_5 2 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_20 from mixer_6 2 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_21 from mixer_4 2 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_22 from mixer_21 2 to mixer_22 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_23 from mixer_12 2 to mixer_13 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_24 from mixer_11 2 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_25 from mixer_8 2 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_26 from mixer_15 2 to mixer_16 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_27 from mixer_13 2 to mixer_14 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_28 from mixer_23 2 to square_cell_trap_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_29 from mixer_22 2 to mixer_23 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_30 from mixer_18 2 to mixer_19 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_31 from mixer_17 2 to mixer_18 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_32 from mixer_2 2 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_33 from mixer_19 2 to mixer_20 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_34 from mixer_20 2 to mixer_21 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_35 from mixer_3 2 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_36 from mixer_16 2 to mixer_17 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_37 from mixer_7 2 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_38 from mixer_1 2 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_39 from port_12 1 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_40 from port_13 1 to mixer_11 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_41 from port_14 1 to mixer_21 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_42 from port_15 1 to mixer_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_43 from port_16 1 to mixer_15 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_44 from port_17 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_45 from port_18 1 to mixer_6 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_46 from port_19 1 to mixer_18 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_47 from port_20 1 to mixer_19 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_48 from port_21 1 to mixer_17 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_49 from port_22 1 to mixer_13 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_50 from port_23 1 to mixer_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_51 from port_24 1 to mixer_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_52 from port_25 1 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_53 from port_26 1 to mixer_12 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_54 from port_27 1 to mixer_16 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_55 from port_28 1 to mixer_23 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_56 from port_29 1 to mixer_22 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_57 from port_30 1 to mixer_14 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_58 from port_31 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_59 from port_32 1 to mixer_20 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_60 from port_33 1 to mixer_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_61 from port_34 1 to mixer_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_62 from port_6 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_63 from port_6 1 to port_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_64 from port_6 1 to port_5 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_65 from port_6 1 to port_7 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_66 from port_6 1 to port_8 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_67 from port_6 1 to port_9 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_68 from port_6 1 to port_10 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_69 from port_6 1 to port_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_70 from port_6 1 to port_11 1 connectionSpacing=1000 channelWidth=400  ;
