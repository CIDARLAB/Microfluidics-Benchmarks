...
LAYER flow
H MUX m1 1 to 8spacing=1000 flowChannelWidth=100 controlChannelWidth=20;
 PORT p1portRadius=200;

 H BANK pb of 8  PORTportRadius=100  spacing=1000 ;
...
LAYER control
 ...
 PORT cp1, cp2, cp3, cp4, cp5, cp6portRadius=200;
