...
H IN MUX m1 1 to 8r=100 flowChannelWidth=100 controlChannelWidth=20;
...
LAYER control
 H BANK b4 of 5  PORTportRadius=100  ;
 H BANK b5 of 4  PORTportRadius=100  ;
...
CHANNEL ccc from la 26 to b5 4 channelWidth=20;
 ...
 H BANK b1 of 5  PORTportRadius=100  ;
 H BANK b3 of 5  PORTportRadius=100  ;
 V BANK b2 of 10  PORTportRadius=100  ;
