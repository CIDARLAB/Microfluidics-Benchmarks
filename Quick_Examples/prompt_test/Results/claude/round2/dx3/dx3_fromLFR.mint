...
CHANNEL channel_5 from nozzle_droplet_generator_1 3 to droplet_splitter_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_6 from droplet_splitter_1 3 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_7 from droplet_splitter_1 3 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_8 from mixer_3 2 to mixer_2 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_9 from mixer_4 2 to mixer_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_10 from port_5 1 to nozzle_droplet_generator_1 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_11 from port_6 1 to mixer_3 1 connectionSpacing=1000 channelWidth=400  ;
CHANNEL channel_12 from port_7 1 to mixer_4 1 connectionSpacing=1000 channelWidth=400  ;
