...
CHANNEL c1 from p1 to n1 w=500;
CHANNEL c2_3 from n1 to n2 w=500;
CHANNEL c4 from n2 to p2 w=500;

CHANNEL c5 from p3 to n3 w=500;
CHANNEL c6_7 from n3 to n4 w=500;
CHANNEL c8 from n4 to p4 w=500;

CHANNEL c9_11 from n1 to n4 w=500;

CHANNEL c12_13 from n2 to v2 w=500;
CHANNEL c14_15 from n3 to v1 w=500;
