...
CHANNEL cc1 from cp1 to m 6 channelWidth=100;
CHANNEL cc2 from cp2 to m 7 channelWidth=100;
CHANNEL cc3 from cp3 to m 8 channelWidth=100;
CHANNEL cc4 from cp4 to m 9 channelWidth=100;
