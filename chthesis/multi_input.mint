...
CHANNEL c3 from m1 3 to ct1 1 channelWidth=100;
CHANNEL c4 from pb2 1 to t1 1 channelWidth=100;
CHANNEL c5 from pb2 2 to t1 2 channelWidth=100;
CHANNEL c6 from t1 3 to x1 1 channelWidth=100;
CHANNEL c7 from x1 2 to ct1 4 channelWidth=100;
CHANNEL c8 from pb3 1 to t2 2 channelWidth=100;
CHANNEL c9 from pb3 2 to t2 3 channelWidth=100;
CHANNEL c10 from t2 1 to x2 2 channelWidth=100;
CHANNEL c11 from x2 1 to ct1 2 channelWidth=100;
CHANNEL c12 from ct1 3 to p1 1 channelWidth=100;
...
CHANNEL cc3 from cp3 2 to v1 3 channelWidth=50;
CHANNEL cc4 from cp4 4 to v2 3 channelWidth=50;
